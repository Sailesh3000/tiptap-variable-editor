...
//   // Function to render preview with filled variables
//   const renderPreview = () => {
//     let previewContent = rawContent;
    
//     VARIABLES.forEach(variable => {
//       const regex = new RegExp(`{{${variable.label}}}`, 'g');
//       previewContent = previewContent.replace(regex, previewData[variable.id] || '');
//     });
...
//                       Variables will be automatically replaced with real data when your template is used.
//                     </p>
//                   </div>
//                 </div>
//               </div>
